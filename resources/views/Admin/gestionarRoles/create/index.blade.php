{{--
    ...
    MEJORAS:
    - Se ha reestructurado todo el HTML para usar las clases y componentes de Bootstrap 5.
    - El formulario ahora se renderiza dentro de un componente 'card' para ser consistente con el resto del tema.
    - Los mensajes de error de validación se muestran correctamente debajo de cada campo.
    - La lista de permisos está organizada y es más legible.
--}}
