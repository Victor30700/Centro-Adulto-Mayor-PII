                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <ul id="formTabs">
                                        <li class="nav-item">
                                            <a class="nav-link {{ $activeTab == 'historia' ? 'active' : '' }}" id="historia-tab" href="{{ $modoEdicion ? route('admin.medico.historia_clinica.edit', ['id_historia' => $historiaClinica->id_historia, 'active_tab' => 'historia']) : route('admin.medico.historia_clinica.register', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'historia']) }}">
                                                1. Historia Clínica
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            @if (($modoEdicion == false && isset($historiaClinica->id_historia)) || ($modoEdicion == true && isset($historiaClinica->id_historia)))
                                                <a class="nav-link {{ $activeTab == 'examenes' ? 'active' : '' }}" id="examenes-tab" href="{{ route('admin.medico.historia_clinica.edit', ['id_historia' => $historiaClinica->id_historia, 'active_tab' => 'examenes']) }}">
                                    ...
                                    <div class="tab-content" id="historiaClinicaTabsContent">
                                        <div class="tab-pane {{ $activeTab == 'historia' ? 'active' : '' }}" id="historia" role="tabpanel" aria-labelledby="historia-tab">
                                            <form id="historia-form" action="{{ $modoEdicion ? route('admin.medico.historia_clinica.updateHistoria', ['id_historia' => $historiaClinica->id_historia]) : route('admin.medico.historia_clinica.storeHistoria', ['id_adulto' => $adulto->id_adulto]) }}" method="POST">
                                                @csrf
                                                @if($modoEdicion)
                                                    @method('PUT')
                                                @endif
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <a href="{{ route('admin.medico.historia_clinica.index') }}" class="btn btn-secondary ms-2">Cancelar</a>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="tab-pane {{ $activeTab == 'examenes' ? 'active' : '' }}" id="examenes" role="tabpanel" aria-labelledby="examenes-tab">
                                            @if ($modoEdicion && isset($historiaClinica->id_historia))
                                                <form id="examenes-form" action="{{ route('admin.medico.historia_clinica.storeExamenes', ['id_historia' => $historiaClinica->id_historia]) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        <a href="{{ route('admin.medico.historia_clinica.edit', ['id_historia' => $historiaClinica->id_historia, 'active_tab' => 'historia']) }}" class="btn btn-info ms-2">← Anterior</a>
