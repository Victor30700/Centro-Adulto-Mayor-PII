                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                {{-- <a href="{{ route('responsable.enfermeria.medico.historia_clinica.show_detalle', ['id_historia' => $historia->id_historia]) }}" class="btn btn-sm btn-info" data-bs-toggle="tooltip" title="Ver Detalles">
                                                                    <i class="fe fe-eye"></i>
                                                                </a> --}}
                                                                ...
                                                                {{-- <form action="{{ route('responsable.enfermeria.medico.historia_clinica.destroy', ['id_historia' => $historia->id_historia]) }}" method="POST" onsubmit="showCustomConfirm(event, '¿Está seguro de que desea eliminar esta Historia Clínica?', this);">
                                                                    @csrf
                                                                    @method('DELETE')
