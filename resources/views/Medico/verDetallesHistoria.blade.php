                ...
                <div class="main-container container-fluid">
                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.medico.historia_clinica.index') }}">Historia Clínica</a></li>
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('admin.medico.historia_clinica.index') }}" class="btn btn-secondary">
                            <i class="fe fe-arrow-left"></i> Volver al listado
                        </a>
                        <a href="{{ route('admin.medico.historia_clinica.edit', ['id_historia' => $historiaClinica->id_historia]) }}" class="btn btn-primary ms-2">
