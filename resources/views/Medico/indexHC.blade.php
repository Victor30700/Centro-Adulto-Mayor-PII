                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                @if($adulto->latestHistoriaClinica)
                                                                    <form action="{{ route('responsable.enfermeria.medico.historia_clinica.destroy', ['id_historia' => $adulto->latestHistoriaClinica->id_historia]) }}"
                                                                          method="POST"
                                                                          class="d-inline form-delete-hc">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
