                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            @if($adulto->latestEnfermeria)
                                                                <a href="{{ route('responsable.enfermeria.enfermeria.edit', ['cod_enf' => $adulto->latestEnfermeria->cod_enf]) }}"
                                                            ...
                                                            @if($adulto->latestEnfermeria)
                                                                <a href="{{ route('responsable.enfermeria.enfermeria.show', ['cod_enf' => $adulto->latestEnfermeria->cod_enf]) }}"
