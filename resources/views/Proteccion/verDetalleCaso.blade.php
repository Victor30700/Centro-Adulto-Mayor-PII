            ...
            <div class="side-app">
                <div class="main-container container-fluid">
                    ...
                    <div class="proteccion-header">
                        <h1 class="page-title">Detalle del Caso</h1>
                    </div>
                    ...
                    <div class="card proteccion-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="proteccion-actions">
                                <a href="{{ route('admin.caso.index') }}" class="btn btn-empresa-secondary">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Se llama a feather.replace() dentro para asegurar que el icono cambie
