...
<div class="container">
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.index') }}">← Volver al listado</a>
                </div>
    <h6>
        @if($modoEdicion)
    ...
    {{-- Tabs --}}
    <ul id="formTabs">
        {{-- Los enlaces de las pestañas ahora siempre apuntan a la ruta 'admin.caso.edit' --}}
        <li><a class="tab-link {{ $activeTab == 'actividad' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'actividad']) }}">1. Actividad</a></li>
        <li><a class="tab-link {{ $activeTab == 'encargado' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'encargado']) }}">2. Encargado</a></li>
        <li><a class="tab-link {{ $activeTab == 'denunciado' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'denunciado']) }}">3. Denunciado</a></li>
        <li><a class="tab-link {{ $activeTab == 'grupo' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'grupo']) }}">4. Grupo Familiar</a></li>
        <li><a class="tab-link {{ $activeTab == 'croquis' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'croquis']) }}">5. Croquis</a></li>
        <li><a class="tab-link {{ $activeTab == 'seguimiento' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'seguimiento']) }}">6. Seguimiento</a></li>
        <li><a class="tab-link {{ $activeTab == 'intervencion' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'intervencion']) }}">7. Intervención</a></li>
        <li><a class="tab-link {{ $activeTab == 'anexo3' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'anexo3']) }}">8. Anexo N3</a></li>
        <li><a class="tab-link {{ $activeTab == 'anexo5' ? 'active' : '' }}" href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'anexo5']) }}">9. Anexo N5</a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane {{ $activeTab == 'actividad' ? 'active' : '' }}" id="actividad">
            <form action="{{ route('admin.caso.storeActividad', $adulto->id_adulto) }}" method="POST">
                @csrf
        ...
        <div class="tab-pane {{ $activeTab == 'encargado' ? 'active' : '' }}" id="encargado">
            <form action="{{ route('admin.caso.storeEncargado', $adulto->id_adulto) }}" method="POST">
                @csrf
                ...
                <div class="navigation-buttons">
                    ...
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'actividad']) }}">← Anterior</a>
                    <button type="submit">Siguiente →</button>
                </div>
            </form>
        </div>
        ...
        <div class="tab-pane {{ $activeTab == 'denunciado' ? 'active' : '' }}" id="denunciado">
            <form action="{{ route('admin.caso.storeDenunciado', $adulto->id_adulto) }}" method="POST">
                @csrf
                ...
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'encargado']) }}">← Anterior</a>
                    <button type="submit">Siguiente →</button>
                </div>
            </form>
        </div>
        ...
        <div class="tab-pane {{ $activeTab == 'grupo' ? 'active' : '' }}" id="grupo">
            <form action="{{ route('admin.caso.storeGrupoFamiliar', $adulto->id_adulto) }}" method="POST">
                @csrf
                <input type="hidden" name="active_tab" value="grupo">
                @include('Proteccion.tabs.grupo', ['adulto' => $adulto, 'modoEdicion' => $modoEdicion])
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'denunciado']) }}">← Anterior</a>
                    <button type="submit">Siguiente →</button>
                </div>
            </form>
        </div>
        ...
        <div class="tab-pane {{ $activeTab == 'croquis' ? 'active' : '' }}" id="croquis">
            <form action="{{ route('admin.caso.storeCroquis', $adulto->id_adulto) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="active_tab" value="croquis">
                @include('Proteccion.tabs.croquis', ['adulto' => $adulto, 'modoEdicion' => $modoEdicion])
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'grupo']) }}">← Anterior</a>
                    <button type="submit">Siguiente →</button>
                </div>
            </form>
        </div>
        ...
        <div class="tab-pane {{ $activeTab == 'seguimiento' ? 'active' : '' }}" id="seguimiento">
            <form action="{{ route('admin.caso.storeSeguimiento', $adulto->id_adulto) }}" method="POST">
                @csrf
                ...
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'croquis']) }}">← Anterior</a>
                    <button type="submit">Siguiente →</button>
                </div>
            </form>
        </div>
        ...
        <div class="tab-pane {{ $activeTab == 'intervencion' ? 'active' : '' }}" id="intervencion">
            <form action="{{ route('admin.caso.storeIntervencion', $adulto->id_adulto) }}" method="POST">
                @csrf
                ...
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'seguimiento']) }}">← Anterior</a>
                    <button type="submit">Siguiente →</button>
                </div>
            </form>
        </div>
        ...
        <div class="tab-pane {{ $activeTab == 'anexo3' ? 'active' : '' }}" id="anexo3">
            <form action="{{ route('admin.caso.storeAnexoN3', $adulto->id_adulto) }}" method="POST">
                @csrf
                <input type="hidden" name="active_tab" value="anexo3">
                @include('Proteccion.tabs.anexo3', ['adulto' => $adulto, 'modoEdicion' => $modoEdicion])
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'intervencion']) }}">← Anterior</a>
                    <button type="submit">Siguiente →</button>
                </div>
            </form>
        </div>
        ...
        <div class="tab-pane {{ $activeTab == 'anexo5' ? 'active' : '' }}" id="anexo5">
            <form action="{{ route('admin.caso.storeAnexoN5', $adulto->id_adulto) }}" method="POST">
                @csrf
                <input type="hidden" name="active_tab" value="anexo5">
                @include('Proteccion.tabs.anexo5', ['adulto' => $adulto, 'modoEdicion' => $modoEdicion])
                <div class="navigation-buttons">
                    <a href="{{ route('admin.caso.edit', ['id_adulto' => $adulto->id_adulto, 'active_tab' => 'anexo3']) }}">← Anterior</a>
