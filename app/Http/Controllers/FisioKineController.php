...
class FisioKineController extends Controller
{
    ...
    public function storeFisio(Request $request, $id_adulto)
    {
        ...
        try {
            ...
            return redirect()->route('admin.fisiokine.indexFisio')->with('success', 'Ficha de Fisioterapia registrada exitosamente.');
    ...
    public function updateFisio(Request $request, $cod_fisio)
    {
        ...
        try {
            ...
            return redirect()->route('admin.fisiokine.indexFisio')->with('success', 'Ficha de Fisioterapia actualizada exitosamente.');
    ...
    public function destroyFisio($cod_fisio)
    {
        try {
            $fisioterapia = Fisioterapia::findOrFail($cod_fisio);
            $fisioterapia->delete();
            return redirect()->route('admin.fisiokine.indexFisio')->with('success', 'Ficha de Fisioterapia eliminada exitosamente.');
        } catch (\Exception $e) {
    ...
    public function storeKine(Request $request, $id_adulto)
    {
        ...
        try {
            ...
            return redirect()->route('admin.fisiokine.indexKine')->with('success', 'Ficha de Kinesiología registrada exitosamente.');
    ...
    public function updateKine(Request $request, $cod_kine)
    {
        ...
        try {
            ...
            return redirect()->route('admin.fisiokine.indexKine')->with('success', 'Ficha de Kinesiología actualizada exitosamente.');
    ...
    public function destroyKine($cod_kine)
    {
        try {
            $kinesiologia = Kinesiologia::findOrFail($cod_kine);
            $kinesiologia->delete();
            return redirect()->route('admin.fisiokine.indexKine')->with('success', 'Ficha de Kinesiología eliminada exitosamente.');
        } catch (\Exception $e) {
