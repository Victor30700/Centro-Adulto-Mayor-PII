...
class HistoriaClinicaController extends Controller
{
    ...
    public function storeHistoriaClinica(Request $request, $id_adulto)
    {
        ...
        try {
            ...
            return redirect()->route('admin.medico.historia_clinica.edit', [
    ...
    public function storeExamenesComplementarios(Request $request, $id_historia)
    {
        ...
        try {
            ...
            return redirect()->route('admin.medico.historia_clinica.index')->with('success', 'Exámenes Complementarios y Medicamentos guardados exitosamente.');
    ...
    public function destroy($id_historia)
    {
        try {
            ...
            return redirect()->route('admin.medico.historia_clinica.index')->with('success', 'Historia Clínica eliminada exitosamente.');
        } catch (\Exception $e) {
