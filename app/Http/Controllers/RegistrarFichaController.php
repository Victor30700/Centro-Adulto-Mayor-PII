...
class RegistrarFichaController extends Controller
{
    ...
    public function storeOrientacion(Request $request)
    {
        ...
        return redirect()->route('admin.orientacion.index')->with('success', 'Orientación registrada exitosamente.');
    }
    ...
    public function edit($id_adulto)
    {
        ...
        if (!$orientacion) {
            return redirect()->route('admin.orientacion.register', ['id_adulto' => $id_adulto])
    ...
    public function updateOrientacion(Request $request, $cod_or)
    {
        ...
        return redirect()->route('admin.orientacion.index')->with('success', 'Ficha de orientación actualizada exitosamente.');
    }
