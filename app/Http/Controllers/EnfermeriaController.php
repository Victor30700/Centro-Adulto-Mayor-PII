...
class EnfermeriaController extends Controller
{
    ...
    public function store(Request $request, $id_adulto)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.enfermeria.index')->with('success', 'Ficha de Enfermería registrada exitosamente.');
    ...
    public function update(Request $request, $cod_enf)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.enfermeria.index')->with('success', 'Ficha de Enfermería actualizada exitosamente.');
    ...
    public function destroy($cod_enf)
    {
        try {
            ...
            return redirect()->route('admin.enfermeria.index')->with('success', 'Ficha de Enfermería eliminada exitosamente.');
        } catch (\Exception $e) {
